...
import { getMyProfile } from "../../api/admin/employees";
      ...
      <main className="main">
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          <button
            ...
            onClick={() => navigate(`/admin/update-my-profile/${profile.id}`)}
          >
            Edit
          </button>
        </div>
          ...
          <div className="card profile-card">
            <div className="profile-card-left">
              <div
                ...
                onClick={() => profile.image && setIsOpen(true)} // ✅ CLICK TO OPEN
                style={{ cursor: profile.image ? "pointer" : "default" }}
              >
                {profile.image ? (
                  <img
                    src={profile.image}
