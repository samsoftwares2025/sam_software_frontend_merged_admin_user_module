...
const MyTickets = () => {
  ...
  useEffect(() => {
    fetchTickets();
  }, [page, statusFilter, searchSubject, typeFilter]);
  ...
  const handleCancelTicket = async () => {
    try {
      ...
      alert(err.message || "Unable to cancel ticket");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container">
      ...
      <main className="main">
        ...
        <section className="card history-card">
          <div className="doc-header">
            ...
            <div className="doc-header-actions">
              <button
                ...
                onClick={() => navigate("/user/support/assigned")}
              >
          ...
          <div className="filter-bar">
            ...
            <input
              type="text"
              placeholder="Search by subject / tracking id / message"
              value={searchSubject}
              onChange={(e) => {
                      ...
                      <tr key={t.id}>
                        ...
                        <td>
                          <button
                            ...
                            disabled={!isPending}
                            onClick={() => openCancelConfirm(t.id)}
                          >
                            Cancel
                          </button>
                        </td>
      ...
      {/* ✅ SIDEBAR OVERLAY (SAME AS OTHER PAGES) */}
      {isSidebarOpen && (
        <div
